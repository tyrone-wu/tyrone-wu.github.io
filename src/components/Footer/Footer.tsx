...
export default function Footer({ textPalette }: { textPalette: string }) {
  return (
    ...
    >
      ...
      <Text>
        💻 Built with{" "}
        <Link fontWeight="medium" href="https://react.dev/" isExternal>
          React
        </Link>{" "}
        &{" "}
        <Link fontWeight="medium" href="https://chakra-ui.com/" isExternal>
          Chakra UI
        </Link>
        .
      </Text>
      ...
      <Link
        href="https://github.com/tyrone-wu/tyrone-wu.github.io"
        isExternal
        mt={1}
      >
